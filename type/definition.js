...
var _objectEntries = _interopRequireDefault(
  require("../polyfills/objectEntries")
);
...
var _defineToStringTag = _interopRequireDefault(
  require("../jsutils/defineToStringTag")
);
...
function assertType(type) {
  if (!isType(type)) {
    throw new Error(
      "Expected ".concat((0, _inspect.default)(type), " to be a GraphQL type.")
    );
  }
  ...
  (function () {
    function GraphQLScalarType(config) {
      ...
      this.parseLiteral =
        ...
        function (node) {
          return parseValue(
            (0, _valueFromASTUntyped.valueFromASTUntyped)(node)
          );
        };
...
var GraphQLObjectType =
  ...
  (function () {
    function GraphQLObjectType(config) {
      ...
      this.astNode = config.astNode;
      this.extensionASTNodes = undefineIfEmpty(config.extensionASTNodes);
      this.pathToFields = config.pathToFields;
...
function defineEnumValues(typeName, valueMap) {
  isPlainObj(valueMap) ||
    (0, _devAssert.default)(
      0,
      "".concat(typeName, " values must be an object with value names as keys.")
    );
